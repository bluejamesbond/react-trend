...
var buildSmoothPath = exports.buildSmoothPath = function buildSmoothPath(data, _ref2) {
  ...
  return 'M ' + firstPoint.x + ',' + firstPoint.y + '\n' + _lodash2.default.map(otherPoints, function (point, index) {
    ...
    var before = (0, _math.moveToOpt)(prev, point, radiusForPoint);
    var after = (0, _math.moveToOpt)(next, point, radiusForPoint);
